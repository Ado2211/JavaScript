/*
        <div class="modal-window">
            <div class="modal-message">What is your username</div>
            <div class="modal-content">
                <div class="modal-row">
                    <input type="text" id="modal-input" value="adnanma">
                </div>
                <div class="modal-row">
                    <button>
                        Confirm
...
function createInputModal(message, defaultValue, callbackConfirm, callbackClose) {
    ...
    let modalConnfirmButton = modalHolder.querySelector('#modal-confirm-button');
    let modalCloseButton = modalHolder.querySelector('#modal-close-button');

    modalConnfirmButton.addEventListener('click', () => {
